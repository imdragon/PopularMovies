            ...
            builder.setTitle(R.string.sort_option).setItems(R.array.sortOptionArray, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    if (which == 0) {
                        ...
                        new RequestPopularMovies(MainActivity.this).execute("popularity.desc", null, null);
                        // popularity.desc
                    }
                    if (which == 1) {
                        setTitle("Highest Rated");
                        // below request shows by highest rating for US movies
                        new RequestPopularMovies(MainActivity.this).execute("certification_country=US&sort_by=vote_average.desc&vote_count.gte=1000", null, null);
                        // rating.desc
                    }
                    if (which == 2) {
